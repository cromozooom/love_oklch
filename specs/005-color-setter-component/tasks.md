...
- [ ] T024 [P] [US1] Create color preview subcomponent in `frontend/src/app/components/color-setter/subcomponents/color-preview/color-preview.component.ts` [Est: 2h]
- [ ] T025 [US1] Create HEX text input control with validation in `frontend/src/app/components/color-setter/subcomponents/color-sliders/hex-input.component.ts` [Est: 2h]
- [ ] T026 [US1] Create RGB sliders subcomponent using Angular CDK in `frontend/src/app/components/color-setter/subcomponents/color-sliders/rgb-sliders.component.ts` [Est: 3h]
- [ ] T027 [US1] Create HSL sliders subcomponent using Angular CDK in `frontend/src/app/components/color-setter/subcomponents/color-sliders/hsl-sliders.component.ts` [Est: 3h]
- [ ] T028 [US1] Implement main component template with format switching logic in `frontend/src/app/components/color-setter/color-setter.component.html` [Est: 2h]
- [ ] T029 [US1] Add Tailwind CSS styling for component layout in `frontend/src/app/components/color-setter/color-setter.component.scss` [Est: 3h]
- [ ] T030 [US1] Implement input validation and clamping in ColorService in `frontend/src/app/components/color-setter/services/color.service.ts` [Est: 2h]
- [ ] T031 [US1] Add debouncing (16ms) for slider updates using RxJS in `frontend/src/app/components/color-setter/color-setter.component.ts` [Est: 1.5h]
- [ ] T032 [US1] Implement computed signals for displayValue in `frontend/src/app/components/color-setter/color-setter.component.ts` [Est: 1h]
